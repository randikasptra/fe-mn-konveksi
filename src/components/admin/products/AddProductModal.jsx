// src/components/admin/products/AddProductModal.jsx
import React, { useState } from 'react'
import { X, Package, ImagePlus, Loader2, Plus } from 'lucide-react'
            ...
            <div className='bg-white w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden animate-fadeIn'>
                ...
                <form onSubmit={handleSubmit} className='p-6'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        ...
                        <div className='space-y-4'>
                            ...
                            <div>
                                ...
                                <input
                                    required
                                    className='w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none text-sm transition'
                    ...
                    <div className='mt-6'>
                        ...
                        <textarea
                            rows={4}
                            className='w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none text-sm resize-none transition'
                    ...
                    <div className='flex items-center gap-3 mt-6 pt-6 border-t'>
                        ...
                        <button
                            type='submit'
                            disabled={loading}
                            className='flex-1 inline-flex items-center justify-center gap-2 bg-indigo-600 text-white py-2.5 rounded-xl font-medium hover:bg-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed'
                        >
                            {loading ? (
                                <>
