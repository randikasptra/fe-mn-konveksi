...
export default function OrdersAdmin() {
    ...
    function getPaymentLabel(order) {
        ...
        const hasPending = transaksi.some(
    ...
    function canKelola(order) {
        return ['MENUNGGU_PEMBAYARAN', 'DIPROSES'].includes(
        ...
        <div className='p-6 bg-gray-50 min-h-screen'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-10'>
                ...
                <div className='bg-white rounded-2xl p-6'>
                    ...
                    <h3 className='text-gray-500 text-sm font-medium'>Pembayaran Lunas</h3>
                    <div className='flex items-center mt-4 pt-4 border-t border-gray-100'>
                        <div className='flex-1 text-center'>
            ...
            <div className='mb-8'>
                ...
                <div className='text-gray-500 text-sm'>
                    Menampilkan <span className='font-medium text-gray-900'>{filteredOrders.length}</span> dari{' '}
                    <span className='font-medium text-gray-900'>{orders.length}</span> pesanan
                </div>
            </div>
                                        ...
                                        >
                                            ...
                                            <td className='py-5 px-7'>
                                                <div className='space-y-2'>
                                                    ...
                                                    <div className={`text-xs px-3 py-1 rounded-full ${getPaymentColor(paymentLabel)}`}>
                                                        <div className='flex items-center'>
                                            ...
                                            <td className='py-5 px-7'>
                                                <div className={`text-sm px-4 py-2 rounded-full inline-flex items-center ${getStatusColor(order.status_pesanan)}`}>
                                            ...
                                            <td className='py-5 px-7'>
                                                <button
                                                    ...
                                                    className={`flex items-center px-5 py-2.5 rounded-xl transition-all ${canKelola(order)
            ...
            {selectedOrder && (
                <OrderKelolaModal
                    ...
                    onSelesaikan={async (order) => {
                        ...
                        if (!res.success) {
                            alert(res.message || 'Gagal menyelesaikan pesanan')
                            return
                        }
